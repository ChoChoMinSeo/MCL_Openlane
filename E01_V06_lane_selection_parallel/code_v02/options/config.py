...
class Config(object):
    ...
    def setting_for_path(self):
        ...
        self.dir['pre6_interpolate'] = f'{self.dir["head_proj"]}/E01_V06_interpolation_only/output_v02_{self.datalist_mode}_for_supp/pickle'
        self.dir['pre6_parallel'] = f'{self.dir["head_proj"]}/E01_V06_parallel/output_v02_{self.datalist_mode}_for_supp/pickle'
