...
class Config(object):
    ...
    def setting_for_path(self):
        ...
        self.dir['pre4'] = f'{self.dir["head_proj"]}/E01_V04_lane_filtering/output_v02_{self.datalist_mode}_for_supp/pickle'
    ...
    def setting_for_lane_refinement(self):
        ...
        # mode = ['linear', 'polynomial','cubic_spline','b-spline','akima_spline','pchip','custom_spline']
        self.extra_mode = 'custom_spline'
        # only valid in polynomial mode
        self.extra_degree = 3
        
        self.scale_factor = 4
        self.thresd_theta1 = 5
        self.thresd_theta2 = 10
        self.thresd_theta3 = 3
        # self.thresd_theta = 6
        self.thresd_angle = 15
